...
describe("Summoner by Leauge Functions", () => {
	...
	describe("Setup", () => {
		it.skip("Check dependency setup", () => {
	...
	describe("HTTP-Requests", () => {
		it.skip("HTTP => Get new SummonerByLeagueCollection - CHALLENGER", async () => {
		...
		it.skip("HTTP => Get new SummonerByLeagueCollection - GRANDMASTER", async () => {
			// Request SummonerByLeagueCollection from RIOT Games API
		...
		it.skip("HTTP => Get new SummonerByLeagueCollection - MASTER", async () => {
			// Request SummonerByLeagueCollection from RIOT Games API
	...
	describe("Functions", () => {
		it.skip("Function => checkIfSummonersByLeagueCanBeUpdated", () => {
